export const defaultAffirmationPrompts = {
  en: 'Generate a short, unique, and uplifting affirmation (up to 50 tokens). Each affirmation should encourage positive thinking, self-worth, motivation, or emotional resilience. Avoid repetition and keep the message clear, concise, and empowering. Use a friendly and supportive tone.',
